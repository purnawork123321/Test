...
public class Solution1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try{
            ...
            Solution1.Inner ob=new Solution1.Inner();

            Class<?> c = Solution1.Inner.class.getDeclaredClasses()[0];
            Constructor<?> constructor =c.getDeclaredConstructor(Solution1.Inner.class);
            constructor.setAccessible(true);
            o=constructor.newInstance(ob);
            Method m = c.getDeclaredMethod("powerof2",new Class[]{int.class}) ;
            m.setAccessible(true);
            String s= (String)m.invoke(o,num);
